    ...
    <nav className="navbar navbar-light bg-white navbar-expand-xl">
      ...
      <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
        <div className="navbar-nav mx-auto">
          <Link
            to="/"
            className={`nav-item nav-link ${vitriRoute.pathname === "/" ? "active" : ""}`}
          >
            Trang chủ
          </Link>
          <Link
          ...
          <Link
            to="/lienhe"
            className={`nav-item nav-link ${vitriRoute.pathname === "/lienhe" ? "active" : ""}`}
          >
            Liên hệ
          </Link>
          <Link
            to="/tracuu"
            className={`nav-item nav-link ${vitriRoute.pathname === "/tracuu" ? "active" : ""}`}
          >
            Tra cứu đơn hàng
          </Link>
        </div>
