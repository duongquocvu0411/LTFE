              ...
              <Col md={6}>
                <Card className="shadow-sm mb-4">
                  <Card.Body>
                    ...
                    {loading ? (
                      <p>Đang tải dữ liệu...</p> // Hiển thị loading trong khi chờ API trả về dữ liệu
                    ) : (
              ...
              <Col md={6}>
                <Card className="shadow-sm mb-4">
                  <Card.Body>
                    ...
                    <Bar data={dataBar} options={options} /> {/* Sử dụng dữ liệu từ API để hiển thị sản phẩm bán chạy */}
                  </Card.Body>
                </Card>
              </Col>
            </Row>
